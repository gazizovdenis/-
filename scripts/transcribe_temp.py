# -*- coding: utf-8 -*-
audio = r'C:\Users\Denis\AppData\Local\Temp\planerka_25may.m4a'
out_path = r'C:\Users\Denis\Desktop\Система\Хранилище\raw\02_Технопродукт\Встречи\2026-05-25_планерка-технопродукт_transcript.md'
...
with open(out_path, 'w', encoding='utf-8') as f:
    f.write('# Планерка Технопродукт — 25.05.2026\n\n')
